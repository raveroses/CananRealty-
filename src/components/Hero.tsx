...
const Hero = () => {
  ...
  return (
    <section className="relative z-0">
      ...
      <section className="absolute top-0 z-10 md:left-20 left-[10px] ">
        <div className=" text-white drop-shadow-lg mt-[150px] ">
          <h1 className="font-bold md:text-[30px] text-[25px] text-wrap">
          ...
          <div className="search text-black md:w-[500px] w-[290px]  max-w-full mt-[20px] ">
          ...
          <div className="icons md:flex gap-5 py-3 grid grid-cols-2">
